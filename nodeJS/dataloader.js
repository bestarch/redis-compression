...
async function executeRedisCommands() {
    ...
    pipeline.zAdd("ABC#123", [
        { score: 10, value: 'XYZ#{123}+789' },
        { score: 20, value: 'XYZ#{345}+123' }
    ]);

    pipeline.set("XYZ#{123}+789", '{"PK":"123","SK":"ABC#123","assetId":"123","totalDuration":1000000,"position":100000,"created_at":1658910745098,"updated_at":1658910745098,"isWatching":true,"isOnAir":true,"language":"","Data":"ABC#123","episodeNumber":1,"showId":123,"seasonId":123}');

    pipeline.set("XYZ#{345}+123", '{"PK":"456","SK":"ABC#231","assetId":"124","totalDuration":1000000,"position":100000,"created_at":1658910745098,"updated_at":1658910745098,"isWatching":true,"isOnAir":true,"language":"","Data":"ABC#325","episodeNumber":2,"showId":123,"seasonId":123}');

    pipeline.hSet("sh_0000000000000000000_000000000", {
        cluster: '{"cluster_id": 00}',
        profile: '{"age": "Adult", "gender": "gender", "top_genre": ["genre"], "top_region": ["Region"]}'
    });

    pipeline.hSet("sh_cluster_00", {
    ...
    pipeline.hSet("0000000000000000000_000000000", {
    ...
    pipeline.hSet("country_region_age_gender", {
    ...
    pipeline.hSet("sh_region_platform", {
    ...
    pipeline.hSet("country_region_platform", {
...
const filePath = 'config/master_data.txt';
